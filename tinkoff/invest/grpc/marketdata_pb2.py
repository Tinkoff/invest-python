...
_GETLASTTRADESREQUEST = _descriptor.Descriptor(
  name='GetLastTradesRequest',
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='figi', full_name='tinkoff.public.invest.api.contract.v1.GetLastTradesRequest.figi', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='from', full_name='tinkoff.public.invest.api.contract.v1.GetLastTradesRequest.from', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='to', full_name='tinkoff.public.invest.api.contract.v1.GetLastTradesRequest.to', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETLASTTRADESRESPONSE = _descriptor.Descriptor(
  name='GetLastTradesResponse',
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='trades', full_name='tinkoff.public.invest.api.contract.v1.GetLastTradesResponse.trades', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETLASTTRADESREQUEST.fields_by_name['from'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_GETLASTTRADESREQUEST.fields_by_name['to'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_GETLASTTRADESRESPONSE.fields_by_name['trades'].message_type = _TRADE
...
DESCRIPTOR.message_types_by_name['GetLastTradesRequest'] = _GETLASTTRADESREQUEST
DESCRIPTOR.message_types_by_name['GetLastTradesResponse'] = _GETLASTTRADESRESPONSE
...
_MARKETDATASERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='GetLastTrades',
    full_name='tinkoff.public.invest.api.contract.v1.MarketDataService.GetLastTrades',
    index=4,
    containing_service=None,
    input_type=_GETLASTTRADESREQUEST,
    output_type=_GETLASTTRADESRESPONSE,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
